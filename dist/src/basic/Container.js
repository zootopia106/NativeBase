...
this.props.children,
platform!=='web'&&_react2.default.createElement(_ToastContainer.ToastContainer,{ref:function ref(c){_ToastContainer.ToastContainer.toastInstance=c;}}),
platform!=='web'&&_react2.default.createElement(_Actionsheet.ActionSheetContainer,{ref:function ref(c){_Actionsheet.ActionSheetContainer.actionsheetInstance=c;}})));


}}]);return Container;}(_react.Component);Container.contextTypes={theme:_react2.default.PropTypes.object};
