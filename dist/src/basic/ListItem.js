...
if(_reactNative.Platform.OS==='ios'||_platform2.default.androidRipple===false||!this.props.onPress||!this.props.onLongPress||_reactNative.Platform.Version<=21||_reactNative.Platform.OS==='web'){
return(
